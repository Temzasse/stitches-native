...
//   B = React.ElementRef<T>
// > = {
//   [k in keyof HTMLElementTagNameMap]: HTMLElementTagNameMap[k] extends B
//     ? k
//     : never;
// }[keyof HTMLElementTagNameMap];

// export interface StitchesComponentWithAutoCompleteForJSXElements<
...
//       : never
//   >(
//     props: VariantsCall<Variants, Medias> & { as: Elm } & Omit<
...
//   // React component
//   <
//     As extends React.ComponentType = DefaultElement extends React.ComponentType
//       ? DefaultElement
//       : never
//   >(
//     props: VariantsCall<Variants, Medias> & { as?: As } & Omit<
...
// export interface StitchesComponentWithAutoCompleteForReactComponents<
//   DefaultElement,
//   Variants = {},
//   Medias extends TMedias = TMedias,
//   Theme = {},
...
//   ThemeMap = {}
// > = {
//   [ElKey in keyof JSX.IntrinsicElements]: <
//     E extends React.ElementType = ElKey,
//     Variants = {},
//     CloneVariants extends Variants = {}
//   >(
//     // prettier-ignore
//     styled: (
// 			(
...
// export type CreateCss = ReactFactory;

// export type Css = TStyledSheet<
//   { initial: '' },
//   {},
//   {},
//   '',
...
// export type Styled = StyledInstance<
//   { initial: '' },
//   {},
//   {},
//   CSSPropertiesToTokenScale
